...
<!-- Bootstrap core CSS -->
<link href="/WaterMelon/assets/css/water.css" rel="stylesheet">
...
<script src="/WaterMelon/Music/js/WaterAudio.js"></script>
<script>
	$(function() {
		$('.water-preplay-button').load('/WaterMelon/MusicPlayP.water?t_ID=<%=t_ID%>');
		$('.water-play-button').load('/WaterMelon/MusicPlay.water?t_ID=<%=t_ID%>');
		$('.water-nextplay-button').load('/WaterMelon/MusicPlayN.water?t_ID=<%=t_ID%>');
		$('.jp-progress').load('/WaterMelon/SeekBar.water?t_ID=<%=t_ID%> #SandPBar');
		$('.water-currentTime').load('/WaterMelon/SeekBar.water?t_ID=<%=t_ID%> #marginct');
		$('.water-duration').load('/WaterMelon/SeekBar.water?t_ID=<%=t_ID%> #margindt');
		$('.jp-volume-bar').load('/WaterMelon/SeekBar.water?t_ID=<%=t_ID%> #marginvb');
...
<!-- 									<div class="jp-current-time mr-3 jp-time" role="timer" aria-label="time"></div> -->
										<div class="water-currentTime mr-3 jp-time">00:00</div>
									<div class="jp-progress d-flex align-items-center mt-1 mb-2">
										<div class="jp-seek-bar">
											<div class="jp-play-bar"></div>
										</div>
									</div>
									<div class="water-duration ml-3" role="timer"
							...
							<div
								...
								<div
									...
									<a id="muteCtr" class="mr-3 adonis-mute-control" role="button" tabindex="0">
				...
				<div class="row justify-content-between">
					<div class="col-auto col-xl-3 d-flex align-items-center pr-0">
						<div class="brand">
							<a
								...
								href="home.jsp#site-content" data-target="homl.jsp#site-content"
								data-content="home.jsp"> <!-- <a class="nav-link adonis-ajax-load" href="single-album.html" data-target="single-album.html" data-content="../demo-03-html/single-album.html">수민</a> -->
					...
					<div
						...
						<div class="nav-item d-none d-md-flex">
							<a href="#"
								onclick="location.href='/WaterMelon/notice.water'"><span
									...
									<ul class="user-settings-menu list-unstyled">
										<li><a href="#" class="inactive-color"
											onclick="location.href='/WaterMelon/accountList.water?id=<%=dto.getId()%>'"><span
												...
												Profile</a></li>
										<li><a class="nav-link adonis-ajax-load" href="/WaterMelon/mylist.water"
                                    data-target="mylist.jsp" data-content="/WaterMelon/mylist.water"><span
												...
												MyList</a></li>
										<li><a href="#" class="inactive-color"
											onclick="location.href='/WaterMelon/account/Logout.jsp'"><span
												class="adonis-icon mr-3 icon-2x"><svg version="1.1"
														xmlns="http://www.w3.org/2000/svg" height="32"
														viewBox="0 0 32 32"> <path
						...
						<div
							...
							<div class="d-inline-block">
								<ul
									...
									<li class="menu-item"><a id="albumLoad" class="nav-link adonis-ajax-load m-item"
                             			 href="#browse-all-albums" data-target="#browse-all-albums"
                              			data-content="/WaterMelon/all-albums.water">Albums</a></li>
									...
									<li class="menu-item"><a
										...
										data-content="/WaterMelon/charts.water">Charts</a></li>
									<li class="menu-item"><a
													...
													<div class="owl-carousel owl-theme-adonis">
														<div class="item">
															<div class="music-img-box">
																<div class="img-box box-rounded-sm h-d-md-shadow">
																	<img class="retina"
																		src="../assets/images/mp3/album1.jpg"
																		data-2x="../assets/images/mp3/album1.jpg"
																		alt="">
														...
														<div class="item">
															<div class="music-img-box">
																<div class="img-box box-rounded-sm h-d-md-shadow">
																	<img class="retina"
																		src="../assets/images/mp3/album2.jpg"
														...
														<div class="item">
															<div class="music-img-box">
																<div class="img-box box-rounded-sm h-d-md-shadow">
																	<img class="retina"
																		src="../assets/images/mp3/album3.jpg"
														...
														<div class="item">
															<div class="music-img-box">
																<div class="img-box box-rounded-sm h-d-md-shadow">
																	<img class="retina"
																		src="../assets/images/new-releases/new-releases-11@2x .jpg"
																		data-2x="assets/images/new-releases/" alt="">
																<div class="row">
																	<div class="col-lg-8 offset-lg-2">
																		<div
																			class="adonis-carousel nav-middle pt-lg-5 adonis-animate pl-3 pr-3"
												...
												<div class="owl-carousel owl-theme-adonis">
													<div class="item">
														<div class="music-img-box">
															<div class="img-box box-rounded-sm">
																<img class="retina"
																	src="../assets/images/mp3/album5.jpg"
																	data-2x="assets/images/new-releases/new-releases-11@2x .jpg"
																	alt="">
																<div class="hover-state">
																	<div class="absolute-bottom-left pl-e-20 pb-e-20">
													...
													<div class="item">
														<div class="music-img-box">
															<div class="img-box box-rounded-sm">
																<img class="retina"
																	src="../assets/images/mp3/album4.jpg"
													...
													<div class="item">
														<div class="music-img-box">
															<div class="img-box box-rounded-sm">
																<img class="retina"
																	src="../assets/images/mp3/album6.jpg"
																	data-2x="assets/images/new-releases/new-releases-11@2x .jpg"
																	alt="">
																<div class="hover-state">
																	<div class="absolute-bottom-left pl-e-20 pb-e-20">
													...
													<div class="item">
														<div class="music-img-box">
															<div class="img-box box-rounded-sm">
																<img class="retina"
																	src="../assets/images/mp3/album7.jpg"
													...
													<div class="item">
														<div class="music-img-box">
															<div class="img-box box-rounded-sm">
																<img class="retina"
																	src="../assets/images/mp3/album8.jpg"
													...
													<div class="item">
														<div class="music-img-box">
															<div class="img-box box-rounded-sm">
																<img class="retina"
																	src="../assets/images/mp3/album9.jpg"
														...
														<div class="owl-carousel owl-theme-adonis">
															<div class="item">
																<div
																	...
																	<div class="img-box img-box-sm box-rounded-sm">
																		<img src="../assets/images/mp3/album10.jpg" alt="">
																	</div>
																	<div class="des">
																		<h6 class="title fs-2">
																...
																<div
																	class="img-box-horizontal music-img-box h-g-bg h-d-shadow">
																	<div class="img-box img-box-sm box-rounded-sm">
																		<img src="../assets/images/mp3/album11.jpg" alt="">
																	</div>
																	<div class="des">
																		<h6 class="title fs-2">
																...
																<div
																	class="img-box-horizontal music-img-box h-g-bg h-d-shadow">
																	<div class="img-box img-box-sm box-rounded-sm">
																		<img src="../assets/images/mp3/album12.jpg" alt="">
																	</div>
																	<div class="des">
																		<h6 class="title fs-2">
																...
																<div
																	class="img-box-horizontal music-img-box h-g-bg h-d-shadow">
																	<div class="img-box img-box-sm box-rounded-sm">
																		<img src="../assets/images/mp3/album13.jpg"alt="">
																	</div>
																	<div class="des">
																		<h6 class="title fs-2">
															...
															<div class="item">
																<div
																	class="img-box-horizontal music-img-box h-g-bg h-d-shadow">
																	<div class="img-box img-box-sm box-rounded-sm">
																		<img src="../assets/images/mp3/album14.jpg" alt="">
																	</div>
																	<div class="des">
																		<h6 class="title fs-2">
																...
																<div
																	class="img-box-horizontal music-img-box h-g-bg h-d-shadow">
																	<div class="img-box img-box-sm box-rounded-sm">
																		<img src="../assets/images/mp3/album15.jpg" alt="">
																	</div>
																	<div class="des">
																		<h6 class="title fs-2">
																...
																<div
																	class="img-box-horizontal music-img-box h-g-bg h-d-shadow">
																	<div class="img-box img-box-sm box-rounded-sm">
																		<img src="../assets/images/mp3/album16.jpg" alt="">
																	</div>
																	<div class="des">
																		<h6 class="title fs-2">
																...
																<div
																	class="img-box-horizontal music-img-box h-g-bg h-d-shadow">
																	<div class="img-box img-box-sm box-rounded-sm">
																		<img src="../assets/images/mp3/album18.jpg" alt="">
																	</div>
																	<div class="des">
																		<h6 class="title fs-2">
															...
															<div class="item">
																<div
																	class="img-box-horizontal music-img-box h-g-bg h-d-shadow">
																	<div class="img-box img-box-sm box-rounded-sm">
																		<img src="../assets/images/mp3/album17.jpg" alt="">
																	</div>
																	<div class="des">
																		<h6 class="title fs-2">
																			<a href="#">Stirring of a fool</a>
																...
																<div
																	class="img-box-horizontal music-img-box h-g-bg h-d-shadow">
																	<div class="img-box img-box-sm box-rounded-sm">
																		<img src="../assets/images/mp3/album19.jpg" alt="">
																	</div>
																	<div class="des">
																		<h6 class="title fs-2">
																			<a href="#">The Separation</a>
																...
																<div
																	class="img-box-horizontal music-img-box h-g-bg h-d-shadow">
																	<div class="img-box img-box-sm box-rounded-sm">
																		<img src="../assets/images/mp3/album20.jpg" alt="">
																	</div>
																	<div class="des">
																		<h6 class="title fs-2">
																			<a href="#">The Separation</a>
